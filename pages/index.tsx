...
export default function Index() {
  return (
    <Layout>
      <Typography level="h2" sx={{ mb: "1rem" }}>Minimalist Joy UI Blog</Typography>
      <Typography sx={{ mb: "1rem" }}>Greetings! Welcome to your sleek new Joy UI blog! ✨</Typography>
      <Typography component="h2" level="h3">Features</Typography>
      <List>
